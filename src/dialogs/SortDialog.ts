...
import {event as d3event, selectAll, Selection} from 'd3-selection';

export default class SortDialog extends ADialog {
  constructor(private readonly column: IBoxPlotColumn, $header: Selection<HTMLElement, Column, any, any>, title: string = 'Change Sort Criteria') {
    super($header, title);
  }
